...
public class DisciplinaResource {
	...
	public ResponseEntity<Void> inserir(@RequestBody Disciplina objDisc) {
		Disciplina disciplina = disciplinaService.salvar(objDisc);
	...
	public ResponseEntity<Void> alterar(@RequestBody Disciplina objDisc, @PathVariable Integer id) {
		objDisc.setId(id);
		disciplinaService.alterar(objDisc);
		return ResponseEntity.noContent().build();
	}
